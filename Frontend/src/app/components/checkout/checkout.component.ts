...
import {MyAppFormService} from 'src/app/services/my-app-form.service';
import {Country} from 'src/app/common/country';
import {State} from 'src/app/common/state';
import {MyApp} from "../../validators/my-App";
...
export class CheckoutComponent implements OnInit {
  ...
  //get email from browser
  storage: Storage=sessionStorage;

  constructor(private formBuilder: FormBuilder,
              private luv2ShopFormService: MyAppFormService,
  ...
  ngOnInit(): void {
    ...
    //read the email address from browser storage
    ...
    this.checkoutFormGroup = this.formBuilder.group({
      customer: this.formBuilder.group({
        ...
        //add auto email to read from browser storage - only theEmail
      ...
      shippingAddress: this.formBuilder.group({
        street: new FormControl('', [Validators.required,
          Validators.minLength(2), MyApp.notOnlyWhitespace]),
